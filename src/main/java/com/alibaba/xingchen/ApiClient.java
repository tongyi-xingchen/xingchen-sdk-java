...
import com.alibaba.xingchen.api.BaseApiSub;
import com.alibaba.xingchen.auth.ApiKeyAuth;
import com.alibaba.xingchen.auth.Authentication;
import com.alibaba.xingchen.auth.HttpBasicAuth;
...
//                .protocols(Collections.singletonList(Protocol.H2_PRIOR_KNOWLEDGE))
     ...
     */
    public ApiClient setDateFormat(DateTimeFormatter dateFormat) {
        JSON.setDateTimeFormatter(dateFormat);
        return this;
    }
    ...
    public boolean isStreamEvent(String mime) {
        return Objects.nonNull(mime) && mime.contains("text/event-stream");
    }
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        } else if (isStreamEvent(contentType)) {
            int i = respBody.indexOf("data:");
            if (i > 0) {
                return JSON.deserialize(respBody.substring(i+5), returnType);
            }
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        // gateway router
        BaseApiSub.setServiceRouterHeader(defaultHeaderMap, path);
